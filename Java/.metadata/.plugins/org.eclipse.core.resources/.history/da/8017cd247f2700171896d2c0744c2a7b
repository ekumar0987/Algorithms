...
public class SortedRotatedArraySearch {
	...
	public static void main(String[] args) {
		...
		// Test Case 3: No array, no element in array
		int[] arr3 = {};
		int index3 = s.search(arr3, 0, arr3.length-1, 7);
		System.out.print("Index:"+index3);
		
		System.out.println();
		
		// Test Case 3: No array, no element in array
		int[] arr4 = {2,2,2,3,4,2};
		int index4 = s.search(arr4, 0, arr4.length-1, 2);
		System.out.print("Index:"+index4);	
	}
